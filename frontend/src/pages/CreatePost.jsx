        ...
        <section className='relative max-w-7xl mx-auto'>
            <div>
                ...
                <p className='mt-2 text-[#666e75] text-[16px] max-w-[500px]'>
                    Create imaginative and visually stunning images generated by DALL-E AI ans shared them with the community.
                </p>
            </div>

            {
                loading ? <div className='absolute inset-0 z-[10] flex justify-center items-center bg-[rgba(0,0,0,0.5)] rounded-lg'><Loader/></div> : <></>
            }
